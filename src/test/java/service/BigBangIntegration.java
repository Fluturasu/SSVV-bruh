...
public class BigBangIntegration {
    ...
    void addGrade() {
        ...
        double valNota = 9;
        int predata = 14;
        String feedback = "bruh";
        service.saveNota(idStudent, idTema, valNota, predata, feedback);
        assertNotNull(fileRepository3.findOne(new Pair<>(idStudent, idTema)));
    }

    @Test
    public void integrate() {
        int returnValue = service.saveStudent("2", "andrei", 933);


        service.saveTema("2", "ok", 14, 1);
